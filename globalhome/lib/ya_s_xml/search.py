...
class SearchResultItem:
    def __init__(self, url, title, snippet, headline):
        self.url = url
        self.title = title
...
class YaSearch:
    ...
    def search(self, query, page=1, site=None, max_page_num=0):
        request_suffix = ''
        if site:
